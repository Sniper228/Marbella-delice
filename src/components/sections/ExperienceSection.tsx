...
export function ExperienceSection() {
  return (
    <section className="relative overflow-hidden py-24 md:py-40">
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-cream via-peach/10 to-cream dark:via-peach/5" />
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 md:px-8 lg:px-12">
        <Reveal className="mx-auto mb-14 max-w-2xl text-center md:mb-16">
          <span className="mb-4 inline-block rounded-full bg-peach/50 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.2em] text-warm-gray dark:bg-peach/15 dark:text-peach">
            Notre promesse
          </span>
