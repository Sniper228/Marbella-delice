export function ProductPrice({ amount }: { amount: number }) {
  ...
  return (
    <div className="flex flex-col gap-0.5">
      <span className="inline-flex w-fit rounded-full border border-charcoal/8 bg-white/50 px-2 py-0.5 text-[9px] font-medium uppercase tracking-[0.18em] text-warm-gray">
        A partir de
      </span>
