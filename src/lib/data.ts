...
export const products = [
  {
    ...
    gradient: "from-strawberry/25 via-peach/15 to-white",
  ...
  },
  {
    ...
    gradient: "from-cream-deep/60 via-peach/25 to-white",
  ...
  },
  {
    ...
    gradient: "from-mango/30 via-peach/20 to-white",
...
export const digitalApps = [
  {
    ...
    href: "#",
    accent: "from-fresh-blue/30 via-cream to-white",
  ...
  },
  {
    ...
    href: "#",
    accent: "from-emerald-100/80 via-cream to-white",
  ...
  },
  {
    ...
    href: "#",
    accent: "from-mango/25 via-peach/20 to-white",
